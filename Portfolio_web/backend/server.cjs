...
const projects = [
  {
    ...
    SpecProblem: "전동 킥보드 사용률 증가로 보행자 사고가 6년간 22배 증가하였고, 특히 1-20대의 사고율이 가장 높았다. 하지만 사회적 안전망은 제대로 구축되어 있지 않았기 때문에 보행자들을 보호하기 위한 프로그램을 개발하게되었다.",
    mission: "2000장의 이미지를 라벨링하여 만든 데이터 셋을 다양하게 증강시키며 mAP 기준 가장 적합한 방법을 적용하였고, 킥보드가 주행하면서 인식이 가능하도록 구현하도록 개발하였다.",
  ...
  },
  {
    ...
    SpecProblem: "항만 자동화 인력 부족 및 실제 훈련 시 발생하는 높은 비용과 사고 리스크",
  ...
  },
  {
    ...
    SpecProblem: "기존 스톡 이미지 시장의 높은 진입 장벽과 낮은 사용자 참여도",
    mission: "사진 거래와 커뮤니티가 결합된 통합형 소통 플랫폼 구축",
